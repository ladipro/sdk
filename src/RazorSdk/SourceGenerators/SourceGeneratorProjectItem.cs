...
namespace Microsoft.NET.Sdk.Razor.SourceGenerators
{
    internal class SourceGeneratorProjectItem : RazorProjectItem
    {
        ...
        public SourceGeneratorProjectItem(string basePath, string filePath, string relativePhysicalPath, string fileKind, AdditionalText additionalText, string? cssScope, GeneratorExecutionContext context)
        {
            ...
            CssScope = cssScope;
            _context = context;
            SetSourceTextFromAdditionalFile(additionalText, context, relativePhysicalPath, filePath);
        }
        ...
        private static void SetSourceTextFromAdditionalFile(AdditionalText additionalText, GeneratorExecutionContext context, string relativePhysicalPath, string filePath)
        {
